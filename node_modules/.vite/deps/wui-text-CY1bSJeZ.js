import { i as elementStyles, n as UiHelperUtil, o as resetStyles, r as colorStyles, t as customElement } from "./exports-CDGmcewz.js";
import { a as nothing, c as notEqual, i as noChange, l as css, n as _$LH, r as html, s as defaultConverter, t as LitElement } from "./lit-CeBuIx8X.js";
...
var ICONS = {
	add: async () => (await import("./add-Ca5gzrXp.js")).addSvg,
	allWallets: async () => (await import("./all-wallets-Dr3Zs8Ne.js")).allWalletsSvg,
	arrowBottomCircle: async () => (await import("./arrow-bottom-circle-BVPmvA9h.js")).arrowBottomCircleSvg,
	appStore: async () => (await import("./app-store-DWEn6C5M.js")).appStoreSvg,
	apple: async () => (await import("./apple-D_E-QaXO.js")).appleSvg,
	arrowBottom: async () => (await import("./arrow-bottom-DcDOwbt8.js")).arrowBottomSvg,
	arrowLeft: async () => (await import("./arrow-left-C0djZ6vu.js")).arrowLeftSvg,
	arrowRight: async () => (await import("./arrow-right-C1TG-Y74.js")).arrowRightSvg,
	arrowTop: async () => (await import("./arrow-top-87cLjRjF.js")).arrowTopSvg,
	bank: async () => (await import("./bank-CwCptc74.js")).bankSvg,
	browser: async () => (await import("./browser-3Gptb0LR.js")).browserSvg,
	card: async () => (await import("./card-VnCTVHow.js")).cardSvg,
	checkmark: async () => (await import("./checkmark-DJhH8GT8.js")).checkmarkSvg,
	checkmarkBold: async () => (await import("./checkmark-bold-Bq-dqsKQ.js")).checkmarkBoldSvg,
	chevronBottom: async () => (await import("./chevron-bottom-D2V9-Sl0.js")).chevronBottomSvg,
	chevronLeft: async () => (await import("./chevron-left-DFSo5meV.js")).chevronLeftSvg,
	chevronRight: async () => (await import("./chevron-right-BPUHgVEo.js")).chevronRightSvg,
	chevronTop: async () => (await import("./chevron-top-Dilb6L3n.js")).chevronTopSvg,
	chromeStore: async () => (await import("./chrome-store-CSDJECEg.js")).chromeStoreSvg,
	clock: async () => (await import("./clock-B4MAs7EQ.js")).clockSvg,
	close: async () => (await import("./close-DeHNTutv.js")).closeSvg,
	compass: async () => (await import("./compass-QQttTuJ_.js")).compassSvg,
	coinPlaceholder: async () => (await import("./coinPlaceholder-DNEminix.js")).coinPlaceholderSvg,
	copy: async () => (await import("./copy-CF6xo9Ef.js")).copySvg,
	cursor: async () => (await import("./cursor-Bi1McFgV.js")).cursorSvg,
	cursorTransparent: async () => (await import("./cursor-transparent-Cjgsp7oK.js")).cursorTransparentSvg,
	desktop: async () => (await import("./desktop-BKtFSt_f.js")).desktopSvg,
	disconnect: async () => (await import("./disconnect-R7zNVXk_.js")).disconnectSvg,
	discord: async () => (await import("./discord-BDV8hFwZ.js")).discordSvg,
	etherscan: async () => (await import("./etherscan-BpdtJa3B.js")).etherscanSvg,
	extension: async () => (await import("./extension-DLVhAFLe.js")).extensionSvg,
	externalLink: async () => (await import("./external-link-DEaVKzZx.js")).externalLinkSvg,
	facebook: async () => (await import("./facebook-L_2jJyuZ.js")).facebookSvg,
	farcaster: async () => (await import("./farcaster-sI0bMWkG.js")).farcasterSvg,
	filters: async () => (await import("./filters-FYgVC2ry.js")).filtersSvg,
	github: async () => (await import("./github-CvZBsmb9.js")).githubSvg,
	google: async () => (await import("./google-CUQByr-z.js")).googleSvg,
	helpCircle: async () => (await import("./help-circle-pgG_-y1O.js")).helpCircleSvg,
	image: async () => (await import("./image-6d35AvVs.js")).imageSvg,
	id: async () => (await import("./id-DHLUW2s0.js")).idSvg,
	infoCircle: async () => (await import("./info-circle-BaGKjjAL.js")).infoCircleSvg,
	lightbulb: async () => (await import("./lightbulb-D-mynfA4.js")).lightbulbSvg,
	mail: async () => (await import("./mail-DnkpzYze.js")).mailSvg,
	mobile: async () => (await import("./mobile-CPx3Nhm7.js")).mobileSvg,
	more: async () => (await import("./more-BL5kye2Q.js")).moreSvg,
	networkPlaceholder: async () => (await import("./network-placeholder-D67Wi-pV.js")).networkPlaceholderSvg,
	nftPlaceholder: async () => (await import("./nftPlaceholder-cp1qrm_b.js")).nftPlaceholderSvg,
	off: async () => (await import("./off-Dw0mYtPU.js")).offSvg,
	playStore: async () => (await import("./play-store-DRTphiru.js")).playStoreSvg,
	plus: async () => (await import("./plus-UcmHraXH.js")).plusSvg,
	qrCode: async () => (await import("./qr-code-BFP2EmQ_.js")).qrCodeIcon,
	recycleHorizontal: async () => (await import("./recycle-horizontal-B0zYdfQl.js")).recycleHorizontalSvg,
	refresh: async () => (await import("./refresh-DDlF2oZL.js")).refreshSvg,
	search: async () => (await import("./search-DjpmgrEI.js")).searchSvg,
	send: async () => (await import("./send-Bnsk73mY.js")).sendSvg,
	swapHorizontal: async () => (await import("./swapHorizontal-BuFPMJVW.js")).swapHorizontalSvg,
	swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-C-cjRADH.js")).swapHorizontalMediumSvg,
	swapHorizontalBold: async () => (await import("./swapHorizontalBold-DYuFV486.js")).swapHorizontalBoldSvg,
	swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-DrYhqv9E.js")).swapHorizontalRoundedBoldSvg,
	swapVertical: async () => (await import("./swapVertical-BVlQYC2R.js")).swapVerticalSvg,
	telegram: async () => (await import("./telegram-DeTBAd1I.js")).telegramSvg,
	threeDots: async () => (await import("./three-dots-B19cphTz.js")).threeDotsSvg,
	twitch: async () => (await import("./twitch-Cat_nRWj.js")).twitchSvg,
	twitter: async () => (await import("./x-B6H_-yh9.js")).xSvg,
	twitterIcon: async () => (await import("./twitterIcon-CJ0aTSBo.js")).twitterIconSvg,
	verify: async () => (await import("./verify-DohxnAhM.js")).verifySvg,
	verifyFilled: async () => (await import("./verify-filled-n53c5-0Z.js")).verifyFilledSvg,
	wallet: async () => (await import("./wallet-BZVEpb2X.js")).walletSvg,
	walletConnect: async () => (await import("./walletconnect-ICck2Hj_.js")).walletConnectSvg,
	walletConnectLightBrown: async () => (await import("./walletconnect-ICck2Hj_.js")).walletConnectLightBrownSvg,
	walletConnectBrown: async () => (await import("./walletconnect-ICck2Hj_.js")).walletConnectBrownSvg,
	walletPlaceholder: async () => (await import("./wallet-placeholder-DqjXq5Gy.js")).walletPlaceholderSvg,
	warningCircle: async () => (await import("./warning-circle-CAPl8KWS.js")).warningCircleSvg,
	x: async () => (await import("./x-B6H_-yh9.js")).xSvg,
	info: async () => (await import("./info-DzioWTqS.js")).infoSvg,
	exclamationTriangle: async () => (await import("./exclamation-triangle-BiltfFTj.js")).exclamationTriangleSvg,
	reown: async () => (await import("./reown-logo-Bp8xhNZS.js")).reownSvg
};
...
//# sourceMappingURL=wui-text-CY1bSJeZ.js.map