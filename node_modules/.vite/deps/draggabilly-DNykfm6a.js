...
var require_get_size = /* @__PURE__ */ __commonJS({ "node_modules/get-size/get-size.js": ((exports, module) => {
	(function(window$1, factory) {
		if (typeof module == "object" && module.exports) module.exports = factory();
		else window$1.getSize = factory();
...
var require_ev_emitter = /* @__PURE__ */ __commonJS({ "node_modules/ev-emitter/ev-emitter.js": ((exports, module) => {
	/**
	* EvEmitter v2.1.1
	* Lil' event emitter
	* MIT License
...
var require_unidragger = /* @__PURE__ */ __commonJS({ "node_modules/unidragger/unidragger.js": ((exports, module) => {
	(function(window$1, factory) {
		if (typeof module == "object" && module.exports) module.exports = factory(window$1, require_ev_emitter());
		else window$1.Unidragger = factory(window$1, window$1.EvEmitter);
	})(typeof window != "undefined" ? window : exports, function factory(window$1, EvEmitter) {
		function Unidragger() {}
		...
		*/
		proto._bindHandles = function(bindMethod, touchAction) {
			this.handles.forEach((handle) => {
				...
				if (window$1.PointerEvent) handle.style.touchAction = touchAction;
			});
		};
		proto.bindActivePointerEvents = function() {
			activeEvents.forEach((eventName) => {
				window$1.addEventListener(eventName, this);
			});
		};
		proto.unbindActivePointerEvents = function() {
			activeEvents.forEach((eventName) => {
				window$1.removeEventListener(eventName, this);
			});
		};
...
var require_draggabilly = /* @__PURE__ */ __commonJS({ "node_modules/draggabilly/draggabilly.js": ((exports, module) => {
	(function(window$1, factory) {
		if (typeof module == "object" && module.exports) module.exports = factory(window$1, require_get_size(), require_unidragger());
		else window$1.Draggabilly = factory(window$1, window$1.getSize, window$1.Unidragger);
	})(typeof window != "undefined" ? window : exports, function factory(window$1, getSize, Unidragger) {
		function noop() {}
		let jQuery = window$1.jQuery;
...
//# sourceMappingURL=draggabilly-DNykfm6a.js.map