...
//#region node_modules/@solflare-wallet/metamask-sdk/node_modules/uuid/dist/esm-browser/rng.js
var getRandomValues;
...
//#endregion
//#region node_modules/@solflare-wallet/metamask-sdk/node_modules/uuid/dist/esm-browser/stringify.js
/**
...
//#endregion
//#region node_modules/@solflare-wallet/metamask-sdk/node_modules/uuid/dist/esm-browser/native.js
var randomUUID = typeof crypto !== "undefined" && crypto.randomUUID && crypto.randomUUID.bind(crypto);
var native_default = { randomUUID };

//#endregion
//#region node_modules/@solflare-wallet/metamask-sdk/node_modules/uuid/dist/esm-browser/v4.js
...
//#endregion
//#region node_modules/@solflare-wallet/metamask-sdk/lib/esm/utils.js
...
//#endregion
//#region node_modules/@solflare-wallet/metamask-sdk/lib/esm/detectProvider.js
	...
	return __awaiter$1(this, void 0, void 0, function* () {
		try {
			...
			if (provider.providers && Array.isArray(provider.providers)) {
				...
				for (const provider$1 of providers) if (yield isSnapSupported(provider$1)) return provider$1;
			}
			if (provider.detected && Array.isArray(provider.detected)) {
				const providers = provider.detected;
				for (const provider$1 of providers) if (yield isSnapSupported(provider$1)) return provider$1;
			}
			if (yield isSnapSupported(provider)) return provider;
			return null;
		} catch (error) {
			console.error(error);
			return null;
...
//#endregion
//#region node_modules/@solflare-wallet/metamask-sdk/lib/esm/standard/solana.js
...
//#endregion
//#region node_modules/@solflare-wallet/metamask-sdk/lib/esm/standard/account.js
...
var StandardSolflareMetaMaskWalletAccount = class StandardSolflareMetaMaskWalletAccount {
	get address() {
	...
	constructor({ address, publicKey, label, icon }) {
		...
		if (new.target === StandardSolflareMetaMaskWalletAccount) Object.freeze(this);
...
//#endregion
//#region node_modules/@solflare-wallet/metamask-sdk/lib/esm/index.js
...
var SolflareMetaMask = class SolflareMetaMask extends eventemitter3_default {
	constructor(config) {
		super();
		...
		this._handleResize = (data) => {
			if (data.resizeMode === "full") {
				if (data.params.mode === "fullscreen") this._expandIframe();
				else if (data.params.mode === "hide") this._collapseIframe();
			} else if (data.resizeMode === "coordinates") this._resizeIframe(data.params);
		};
		this._handleMessage = (event) => {
			var _a;
			if (((_a = event.data) === null || _a === void 0 ? void 0 : _a.channel) !== "solflareIframeToWalletAdapter") return;
			const data = event.data.data || {};
			if (data.type === "event") this._handleEvent(data.event);
			else if (data.type === "resize") this._handleResize(data);
		...
		this._removeDanglingElements = () => {
			...
			for (const element of elements) if (element.parentElement) element.remove();
		};
		this._injectElement = () => {
			this._removeElement();
			this._removeDanglingElements();
    ...
    `;
		...
		this._sendIframeMessage = (data) => {
			if (!this.connected || !this.publicKey) throw new Error("Wallet not connected");
			return new Promise((resolve, reject) => {
				...
				(_b = (_a = this._iframe) === null || _a === void 0 ? void 0 : _a.contentWindow) === null || _b === void 0 || _b.postMessage({
		...
		if (config === null || config === void 0 ? void 0 : config.network) this._network = config === null || config === void 0 ? void 0 : config.network;
		if (window.SolflareMetaMaskParams) this._iframeParams = Object.assign(Object.assign({}, this._iframeParams), window.SolflareMetaMaskParams);
		if (config === null || config === void 0 ? void 0 : config.params) this._iframeParams = Object.assign(Object.assign({}, this._iframeParams), config === null || config === void 0 ? void 0 : config.params);
	}
	get publicKey() {
	...
	signTransaction(transaction) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			try {
				...
				const { transaction: signedTransaction } = yield this._sendIframeMessage({
					method: "signTransactionV2",
					params: { transaction: import_bs58.default.encode(serializedTransaction) }
				});
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			try {
				...
				const { transactions: signedTransactions } = yield this._sendIframeMessage({
					...
					params: { transactions: serializedTransactions.map((transaction) => import_bs58.default.encode(transaction)) }
				});
	...
	standardSignAndSendTransaction(...inputs) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			} else if (inputs.length > 1) for (const input of inputs) outputs.push(...yield this.standardSignAndSendTransaction(input));
			return outputs;
		});
	}
	...
	standardSignMessage(...inputs) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			} else if (inputs.length > 1) for (const input of inputs) outputs.push(...yield this.standardSignMessage(input));
			return outputs;
		});
	}
};
...
//# sourceMappingURL=esm-DOhWGRtP.js.map