...
import { St as init_index_browser_esm, j as PublicKey, jt as require_safe_buffer } from "./index.browser.esm-CCXoTR2h.js";
import "./browser-external_buffer-X3Ug0HYL.js";

//#region node_modules/salmon-adapter-sdk/node_modules/eventemitter3/index.js
var require_eventemitter3$1 = /* @__PURE__ */ __commonJS({ "node_modules/salmon-adapter-sdk/node_modules/eventemitter3/index.js": ((exports, module) => {
	var has$1 = Object.prototype.hasOwnProperty, prefix$1 = "~";
	/**
	...
	*/
	...
	if (Object.create) {
		...
		if (!new Events$1().__proto__) prefix$1 = false;
	}
	/**
	...
	* @private
	*/
	function addListener$1(emitter, event, fn, context, once) {
		if (typeof fn !== "function") throw new TypeError("The listener must be a function");
		var listener = new EE$1(fn, context || emitter, once), evt = prefix$1 ? prefix$1 + event : event;
	...
	* @private
	*/
	function clearEvent$1(emitter, evt) {
	...
	*/
	EventEmitter$4.prototype.eventNames = function eventNames() {
		...
		for (name in events = this._events) if (has$1.call(events, name)) names.push(prefix$1 ? name.slice(1) : name);
	...
	* @public
	*/
	EventEmitter$4.prototype.listeners = function listeners(event) {
	...
	* @public
	*/
	EventEmitter$4.prototype.listenerCount = function listenerCount(event) {
	...
	* @public
	*/
	EventEmitter$4.prototype.emit = function emit(event, a1, a2, a3, a4, a5) {
	...
	* @public
	*/
	EventEmitter$4.prototype.on = function on(event, fn, context) {
		return addListener$1(this, event, fn, context, false);
	};
	/**
	...
	* @public
	*/
	EventEmitter$4.prototype.once = function once(event, fn, context) {
		return addListener$1(this, event, fn, context, true);
	};
	/**
	...
	* @public
	*/
	EventEmitter$4.prototype.removeListener = function removeListener(event, fn, context, once) {
		var evt = prefix$1 ? prefix$1 + event : event;
		if (!this._events[evt]) return this;
		if (!fn) {
			clearEvent$1(this, evt);
			return this;
		}
		var listeners = this._events[evt];
		if (listeners.fn) {
			if (listeners.fn === fn && (!once || listeners.once) && (!context || listeners.context === context)) clearEvent$1(this, evt);
		} else {
			for (var i = 0, events = [], length = listeners.length; i < length; i++) if (listeners[i].fn !== fn || once && !listeners[i].once || context && listeners[i].context !== context) events.push(listeners[i]);
			if (events.length) this._events[evt] = events.length === 1 ? events[0] : events;
			else clearEvent$1(this, evt);
		}
		return this;
	};
	/**
	...
	* @public
	*/
	EventEmitter$4.prototype.removeAllListeners = function removeAllListeners(event) {
		var evt;
		if (event) {
			evt = prefix$1 ? prefix$1 + event : event;
			if (this._events[evt]) clearEvent$1(this, evt);
		} else {
			this._events = new Events$1();
			this._eventsCount = 0;
		}
	...
	EventEmitter$4.prototype.addListener = EventEmitter$4.prototype.on;
	EventEmitter$4.prefixed = prefix$1;
	EventEmitter$4.EventEmitter = EventEmitter$4;
	if ("undefined" !== typeof module) module.exports = EventEmitter$4;
}) });

//#endregion
//#region node_modules/salmon-adapter-sdk/lib/esm/adapters/base.js
var import_eventemitter3$2 = /* @__PURE__ */ __toESM(require_eventemitter3$1());
...
var WalletAdapter = function(_super) {
	__extends$3(WalletAdapter$1, _super);
	function WalletAdapter$1() {
		return _super !== null && _super.apply(this, arguments) || this;
	}
	return WalletAdapter$1;
}(import_eventemitter3$2.default);
var base_default = WalletAdapter;

//#endregion
//#region node_modules/@project-serum/sol-wallet-adapter/node_modules/eventemitter3/index.js
var require_eventemitter3 = /* @__PURE__ */ __commonJS({ "node_modules/@project-serum/sol-wallet-adapter/node_modules/eventemitter3/index.js": ((exports, module) => {
...
//#endregion
//#region node_modules/@project-serum/sol-wallet-adapter/node_modules/base-x/src/index.js
var require_src = /* @__PURE__ */ __commonJS({ "node_modules/@project-serum/sol-wallet-adapter/node_modules/base-x/src/index.js": ((exports, module) => {
	var _Buffer = require_safe_buffer().Buffer;
	function base(ALPHABET$1) {
		if (ALPHABET$1.length >= 255) throw new TypeError("Alphabet too long");
		var BASE_MAP = new Uint8Array(256);
		for (var j = 0; j < BASE_MAP.length; j++) BASE_MAP[j] = 255;
		for (var i = 0; i < ALPHABET$1.length; i++) {
			var x = ALPHABET$1.charAt(i);
...
//#endregion
//#region node_modules/@project-serum/sol-wallet-adapter/node_modules/bs58/index.js
var require_bs58 = /* @__PURE__ */ __commonJS({ "node_modules/@project-serum/sol-wallet-adapter/node_modules/bs58/index.js": ((exports, module) => {
...
//#endregion
//#region node_modules/@project-serum/sol-wallet-adapter/dist/esm/index.js
var import_eventemitter3$1 = /* @__PURE__ */ __toESM(require_eventemitter3());
...
var Wallet = class extends import_eventemitter3$1.default {
	...
	handleDisconnect() {
		...
		this._responsePromises.forEach(([, reject], id) => {
			...
			reject(/* @__PURE__ */ new Error("Wallet disconnected"));
		});
	}
	...
	signTransaction(transaction) {
		return __awaiter$3(this, void 0, void 0, function* () {
			const response = yield this.sendRequest("signTransaction", { message: import_bs58.default.encode(transaction.serializeMessage()) });
	...
	signAllTransactions(transactions) {
		return __awaiter$3(this, void 0, void 0, function* () {
			const response = yield this.sendRequest("signAllTransactions", { messages: transactions.map((tx) => import_bs58.default.encode(tx.serializeMessage())) });
	...
	diffieHellman(publicKey) {
		return __awaiter$3(this, void 0, void 0, function* () {
			...
			return yield this.sendRequest("diffieHellman", { publicKey });
		});
	}
};
function isString(a) {
...
//#endregion
//#region node_modules/salmon-adapter-sdk/lib/esm/adapters/web.js
...
var WebAdapter = function(_super) {
	__extends$2(WebAdapter$1, _super);
	function WebAdapter$1(provider, network) {
	...
	Object.defineProperty(WebAdapter$1.prototype, "publicKey", {
		get: function() {
	...
	Object.defineProperty(WebAdapter$1.prototype, "connected", {
		get: function() {
	...
	WebAdapter$1.prototype.connect = function() {
				...
				switch (_a.label) {
					case 0:
						...
						this._pollTimer = window.setInterval(function() {
							var _a$1, _b;
							if (((_b = (_a$1 = _this._instance) === null || _a$1 === void 0 ? void 0 : _a$1._popup) === null || _b === void 0 ? void 0 : _b.closed) !== false) _this._handleDisconnect();
						}, 200);
	...
	WebAdapter$1.prototype.disconnect = function() {
		return __awaiter$2(this, void 0, void 0, function() {
			return __generator$2(this, function(_a) {
				switch (_a.label) {
					case 0:
	...
	WebAdapter$1.prototype.signTransaction = function(transaction) {
		return __awaiter$2(this, void 0, void 0, function() {
			return __generator$2(this, function(_a) {
				switch (_a.label) {
					case 0:
	...
	WebAdapter$1.prototype.signAllTransactions = function(transactions) {
		return __awaiter$2(this, void 0, void 0, function() {
			return __generator$2(this, function(_a) {
				switch (_a.label) {
					case 0:
	...
	WebAdapter$1.prototype.signMessage = function(data, display) {
...
//#endregion
//#region node_modules/salmon-adapter-sdk/lib/esm/adapters/extension.js
...
var ExtensionAdapter = function(_super) {
	__extends$1(ExtensionAdapter$1, _super);
	function ExtensionAdapter$1(provider, network) {
		var _this = _super.call(this) || this;
		_this._provider = provider;
		_this._network = network;
		return _this;
	}
	Object.defineProperty(ExtensionAdapter$1.prototype, "publicKey", {
		get: function() {
	...
	Object.defineProperty(ExtensionAdapter$1.prototype, "connected", {
		get: function() {
	...
	ExtensionAdapter$1.prototype.connect = function() {
	...
	ExtensionAdapter$1.prototype.disconnect = function() {
		return __awaiter$1(this, void 0, void 0, function() {
			return __generator$1(this, function(_a) {
				switch (_a.label) {
					case 0:
	...
	ExtensionAdapter$1.prototype.signTransaction = function(transaction) {
		return __awaiter$1(this, void 0, void 0, function() {
			return __generator$1(this, function(_a) {
				switch (_a.label) {
					case 0:
	...
	ExtensionAdapter$1.prototype.signAllTransactions = function(transactions) {
		return __awaiter$1(this, void 0, void 0, function() {
			return __generator$1(this, function(_a) {
				switch (_a.label) {
					case 0:
	...
	ExtensionAdapter$1.prototype.signMessage = function(data) {
		return __awaiter$1(this, void 0, void 0, function() {
			var signature;
			return __generator$1(this, function(_a) {
				switch (_a.label) {
	...
	return ExtensionAdapter$1;
}(base_default);
var extension_default = ExtensionAdapter;

//#endregion
//#region node_modules/salmon-adapter-sdk/lib/esm/index.js
...
var Salmon = function(_super) {
	__extends(Salmon$1, _super);
	function Salmon$1(config) {
		var _this = _super.call(this) || this;
	...
	Object.defineProperty(Salmon$1.prototype, "publicKey", {
		get: function() {
			var _a;
	...
	Object.defineProperty(Salmon$1.prototype, "isConnected", {
		get: function() {
			var _a;
	...
	Object.defineProperty(Salmon$1.prototype, "connected", {
		get: function() {
	...
	Object.defineProperty(Salmon$1.prototype, "autoApprove", {
		get: function() {
			return false;
		},
		enumerable: false,
	...
	Salmon$1.prototype.connect = function() {
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						...
						if (typeof this._provider === "string") this._adapterInstance = new web_default(this._provider, this._network);
						else this._adapterInstance = new extension_default(this._provider, this._network);
	...
	Salmon$1.prototype.disconnect = function() {
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
	...
	Salmon$1.prototype.signTransaction = function(transaction) {
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
	...
	Salmon$1.prototype.signAllTransactions = function(transactions) {
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
	...
	Salmon$1.prototype.signMessage = function(data, display) {
	...
	Salmon$1.prototype.sign = function(data, display) {
		if (display === void 0) display = "utf8";
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
...
//# sourceMappingURL=esm-CvV9kSnn.js.map