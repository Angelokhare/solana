...
import { Et as init_eventemitter3, St as init_index_browser_esm, Tt as eventemitter3_default, j as PublicKey, mt as VersionedTransaction, nt as Transaction } from "./index.browser.esm-CCXoTR2h.js";
...
var WalletAdapter = function(_super) {
	__extends$4(WalletAdapter$1, _super);
...
init_eventemitter3();
var import_bs58$2 = /* @__PURE__ */ __toESM(require_bs58());
...
var Wallet = function(_super) {
	__extends$3(Wallet$1, _super);
	function Wallet$1(provider, network) {
			...
			return __awaiter$3(_this, void 0, void 0, function() {
				...
				return __generator$3(this, function(_a) {
					...
					return [2, new Promise(function(resolve, reject) {
						_this$1._responsePromises.set(requestId, [resolve, reject]);
						if (_this$1._injectedProvider) _this$1._injectedProvider.postMessage({
							jsonrpc: "2.0",
							id: requestId,
							method,
							params: __assign$2({ network: _this$1._network }, params)
						});
						else {
							_this$1._popup.postMessage({
								jsonrpc: "2.0",
								id: requestId,
								method,
								params
							}, _this$1._providerUrl.origin);
							if (!_this$1.autoApprove) _this$1._popup.focus();
						}
					})];
				});
			});
			...
			return __awaiter$3(_this, void 0, void 0, function() {
				...
				return __generator$3(this, function(_a) {
					switch (_a.label) {
						...
						case 1:
							response = _a.sent();
							signature = import_bs58$2.default.decode(response.signature);
	...
	Object.defineProperty(Wallet$1.prototype, "publicKey", {
		get: function() {
	...
	Object.defineProperty(Wallet$1.prototype, "connected", {
		get: function() {
	...
	Object.defineProperty(Wallet$1.prototype, "autoApprove", {
		get: function() {
...
var import_bs58$1 = /* @__PURE__ */ __toESM(require_bs58());
...
var WebAdapter = function(_super) {
	...
	function WebAdapter$1(iframe, network, provider) {
		var _this = _super.call(this) || this;
		...
		return __awaiter$2(this, void 0, void 0, function() {
			...
			return __generator$2(this, function(_a) {
				switch (_a.label) {
					case 0:
						if (!this.connected) throw new Error("Wallet not connected");
						return [4, this._sendRequest("signTransactionV2", { transaction: import_bs58$1.default.encode(transaction) })];
					case 1:
						signedTransaction = _a.sent().transaction;
						return [2, import_bs58$1.default.decode(signedTransaction)];
				}
			});
		});
	};
				...
				switch (_a.label) {
					case 0:
						...
						return [4, this._sendRequest("signAllTransactionsV2", { transactions: transactions.map(function(transaction) {
							return import_bs58$1.default.encode(transaction);
						}) })];
					case 1:
						signedTransactions = _a.sent().transactions;
						return [2, signedTransactions.map(function(transaction) {
							return import_bs58$1.default.decode(transaction);
						})];
				}
			});
		});
	};
	WebAdapter$1.prototype.signAndSendTransaction = function(transaction, options) {
		return __awaiter$2(this, void 0, void 0, function() {
			var response;
			return __generator$2(this, function(_a) {
				switch (_a.label) {
					case 0:
						...
						return [4, this._sendRequest("signAndSendTransaction", {
							transaction: import_bs58$1.default.encode(transaction),
							options
						})];
					case 1:
						response = _a.sent();
...
//#endregion
//#region node_modules/@solflare-wallet/sdk/node_modules/uuid/dist/esm-browser/native.js
...
var IframeAdapter = function(_super) {
	__extends$1(IframeAdapter$1, _super);
	function IframeAdapter$1(iframe, publicKey) {
		var _this = this;
		var _a;
		...
		_this.handleMessage = function(data) {
			if (_this._messageHandlers[data.id]) {
				var _a$1 = _this._messageHandlers[data.id], resolve = _a$1.resolve, reject = _a$1.reject;
		...
		_this._sendMessage = function(data) {
			...
			return new Promise(function(resolve, reject) {
				...
				(_b = (_a$1 = _this._iframe) === null || _a$1 === void 0 ? void 0 : _a$1.contentWindow) === null || _b === void 0 || _b.postMessage({
	...
	Object.defineProperty(IframeAdapter$1.prototype, "publicKey", {
		get: function() {
			return this._publicKey || null;
		},
		enumerable: false,
	...
	Object.defineProperty(IframeAdapter$1.prototype, "connected", {
		get: function() {
			return true;
		},
		enumerable: false,
	...
	IframeAdapter$1.prototype.connect = function() {
	...
	IframeAdapter$1.prototype.disconnect = function() {
		return __awaiter$1(this, void 0, void 0, function() {
			return __generator$1(this, function(_a) {
				switch (_a.label) {
	...
	IframeAdapter$1.prototype.signTransaction = function(transaction) {
		var _a;
		return __awaiter$1(this, void 0, void 0, function() {
	...
	IframeAdapter$1.prototype.signAllTransactions = function(transactions) {
		var _a;
		return __awaiter$1(this, void 0, void 0, function() {
	...
	IframeAdapter$1.prototype.signAndSendTransaction = function(transaction, options) {
		var _a;
		return __awaiter$1(this, void 0, void 0, function() {
			var result, e_3;
			return __generator$1(this, function(_b) {
	...
	IframeAdapter$1.prototype.signMessage = function(data, display) {
		var _a;
		if (display === void 0) display = "hex";
		return __awaiter$1(this, void 0, void 0, function() {
			var result, e_4;
...
//#endregion
//#region node_modules/@solflare-wallet/sdk/lib/esm/version.js
var VERSION = "1.4.2";
...
var Solflare = function(_super) {
	__extends(Solflare$1, _super);
	function Solflare$1(config) {
		var _this = _super.call(this) || this;
		...
		_this._injectElement = function() {
			...
			var iframeUrl = "".concat(Solflare$1.IFRAME_URL, "?").concat(queryString);
	...
	Object.defineProperty(Solflare$1.prototype, "publicKey", {
		get: function() {
			var _a;
	...
	Object.defineProperty(Solflare$1.prototype, "isConnected", {
		get: function() {
			var _a;
	...
	Object.defineProperty(Solflare$1.prototype, "connected", {
		get: function() {
	...
	Object.defineProperty(Solflare$1.prototype, "autoApprove", {
		get: function() {
			return false;
		},
		enumerable: false,
	...
	Solflare$1.prototype.connect = function() {
	...
	Solflare$1.prototype.disconnect = function() {
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
	...
	Solflare$1.prototype.signTransaction = function(transaction) {
		return __awaiter(this, void 0, void 0, function() {
	...
	Solflare$1.prototype.signAllTransactions = function(transactions) {
		return __awaiter(this, void 0, void 0, function() {
	...
	Solflare$1.prototype.signAndSendTransaction = function(transaction, options) {
		return __awaiter(this, void 0, void 0, function() {
	...
	Solflare$1.prototype.signMessage = function(data, display) {
	...
	Solflare$1.prototype.sign = function(data, display) {
		if (display === void 0) display = "utf8";
		return __awaiter(this, void 0, void 0, function() {
			return __generator(this, function(_a) {
				switch (_a.label) {
	...
	Solflare$1.prototype.detectWallet = function(timeout) {
		var _a;
			...
			return __generator(this, function(_b) {
				...
				return [2, new Promise(function(resolve) {
					var pollInterval = setInterval(function() {
						var _a$1;
						if (window.SolflareApp || ((_a$1 = window.solflare) === null || _a$1 === void 0 ? void 0 : _a$1.isSolflare)) {
	...
	Solflare$1.IFRAME_URL = "https://connect.solflare.com/";
	return Solflare$1;
}(eventemitter3_default);
...
//# sourceMappingURL=esm-DE9kx8Tj.js.map